...
export async function getBugs(req,res){
    try {
        const { textSearch, minSeverity, labels, sortBy, sortDir, pageIdx, createdBy } = req.query
        const filterBy = { textSearch, minSeverity : +minSeverity, labels, pageIdx, createdBy}
